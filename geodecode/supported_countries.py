...
brackets_country_codes = re.findall(r"\([^)]*\)", countries)

no_brackets_country_codes = [re.sub(r"[()]", "", country) for country in brackets_country_codes ]

country_codes = no_brackets_country_codes
